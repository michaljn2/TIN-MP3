        ...
        <tr>
            ...
            <td>
                <ul className="list-actions">
                    <li><Link to={`/groups/details/${stud._id}`} className="list-actions-button-details">
                        <img src="/public/img/INFO.png" alt="Details" className="action-icon"/>
                    </Link></li>
                    <li><Link to={`/groups/edit/${stud._id}`} className="list-actions-button-edit">
                        <img src="/public/img/EDIT.png" alt="Edit" className="action-icon"/>
                    </Link></li>
                    <li><Link to={`/groups/delete/${stud._id}`} className="list-actions-button-delete">
